# OmniDerm Terms of Use

**Effective 27 August 2026 · Prameya LLC**

## 1. Who we are, and what this covers

OmniDerm is published by Prameya LLC, a Texas limited liability company. These terms govern your use
...
## 2. What OmniDerm is, and is not

OmniDerm is a dermatology education and photo-journaling tool. It is not a diagnosis, it is not a medical device, and it does not replace a dermatologist.

OmniDerm does not replace a qualified professional. Do not delay seeking professional help because of
...
OmniDerm stores it on your device. We do not run a server that receives it, we cannot read it, and we
cannot recover it for you if you delete it or lose the device.

## 4. What you agree not to do

Use OmniDerm lawfully. Do not resell it, redistribute its content as your own, or present its output
as professional advice to someone who is relying on you as a professional.

## 5. Purchases, auto-renewal and cancellation

OmniDerm is free to use. **OmniDerm Pro** is one upgrade sold as three products:
...
**How to cancel.** Open the **Settings** app → tap your name → **Subscriptions** → OmniDerm → **Cancel
...
**To the maximum extent Texas law allows**, OmniDerm is provided "as is", without warranties of
...
the greater of the amount you paid Prameya for OmniDerm in the twelve months before the claim, or
$100 USD.**
...
these terms or OmniDerm will be settled by **binding individual arbitration** administered by the
...
Prameya LLC · admin@prameya.legal · Privacy policy: https://prameyallc.github.io/privacy/omniderm/
