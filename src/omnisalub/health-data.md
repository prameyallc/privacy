...
- **Apple Inc.** — operates the App Store, Apple Health, iCloud, Handoff, the connection between iPhone and Apple Watch, and Apple Intelligence. In detail:
    ...
    - **Handoff** passes the tab you are on to your own nearby devices signed in to the same Apple Account. It never carries the Learn topic you are reading, and never a reading.
...
**24 September 2026 — what changed.** Our answer is unchanged: Prameya collects, shares and sells no consumer health data. This revision describes an app update:

- Section 8 says that **Connect Apple Health** now asks for every Apple Health type the app can use, whichever conditions you track, unless you turn off **Import everything from Health** in Settings, which limits the request, and what the app reads, to the types your conditions use. What the app imports still stays on your device.
- Section 4 says that Handoff now passes only the tab you are on, not the Learn topic you are reading.
...
- Section 8 now lists what the app handles on your device, and says that **Connect Apple Health** asks only for the types the conditions you track use and imports the last 400 days of each of those types you allow (records of the symptom types it asks for in full).
