...
OmniMathematics is published by Prameya LLC, a Texas limited liability company. These terms govern your use
...
OmniMathematics is a mathematics learning app. It is not a course of study for credit, it is not an assessment, and it awards no credential.

OmniMathematics does not replace a qualified professional. Do not delay seeking professional help because of
...
OmniMathematics stores it on your device. We do not run a server that receives it, we cannot read it, and we
cannot recover it for you if you delete it or lose the device.

## 4. What you agree not to do

Use OmniMathematics lawfully. Do not resell it, redistribute its content as your own, or present its output
...
**How to cancel.** Open the **Settings** app → tap your name → **Subscriptions** → OmniMathematics → **Cancel
...
**To the maximum extent Texas law allows**, OmniMathematics is provided "as is", without warranties of
...
the greater of the amount you paid Prameya for OmniMathematics in the twelve months before the claim, or
$100 USD.**
...
these terms or OmniMathematics will be settled by **binding individual arbitration** administered by the
